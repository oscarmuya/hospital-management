...
export const sessionDuration = 59;

export const pass = "ctyhuiixqceyqukx";
...
export function getUniqueValues(
  ...
  const array2Codes = array2.map((item) => item.country);
  return array1.filter((item) => !array2Codes.includes(item.country));
}
